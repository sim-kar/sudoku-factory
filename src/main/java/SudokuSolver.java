...
public class SudokuSolver implements Solver {
     ...
     * The solution is generated by choosing numbers in random order, so if there are multiple
     * solutions for the given board, generated solutions will not necessarily be the same.
     *
